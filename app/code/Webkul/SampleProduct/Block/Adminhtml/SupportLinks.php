...
class SupportLinks extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    {
        $moduleCode = 'Webkul_SampleProduct';
        ...
        <p>'.__('User Guide').': 
        <a target="_blank" href="https://webkul.com/blog/magento2-product-sample/">'
        .__('Click Here').'</a></p>
        <p>'.__('Store Extension').': 
        <a target="_blank" href="https://store.webkul.com/magento2-sample-product.html">'
        .__('Click Here').'</a></p>
