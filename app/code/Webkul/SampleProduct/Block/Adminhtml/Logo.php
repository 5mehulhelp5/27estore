...
class Logo extends \Magento\Backend\Block\Template
{
    ...
    public const MODULE_NAME = 'Webkul_SampleProduct';

    public const EXPIRE_CONFIG_PATH = 'sampleproduct/webkul/logo_expire_time';

    public const LOGO_CONFIG_PATH = 'sampleproduct/webkul/logo';
